...
public class zad14_2 {
	...
	public static String header = "%-12s%-10s%-10s%-10s%-10s%n";
	public static String timeData = "%-12s%-10s%-10s%-10s%-10s%n";
	
	public static void main(String[] args) {
		System.out.printf(header, "ArraySize", "Bubble", "Selection", "Merge", "Quick");
	...
	public static void compareSortingForNElements(int n) {
		...
		System.out.printf(timeData,n,timeB,timeS,timeM,timeQ);
	}
